...
public class RobotMap {
    ...
    public static AHRS sensorsNavX;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public static void init() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        driveTrainTalonFL = new CANTalon(0);
        LiveWindow.addActuator("DriveTrain", "TalonFL", driveTrainTalonFL);
        
        driveTrainTalonFR = new CANTalon(1);
        LiveWindow.addActuator("DriveTrain", "TalonFR", driveTrainTalonFR);
        
        driveTrainTalonRL = new CANTalon(2);
        LiveWindow.addActuator("DriveTrain", "TalonRL", driveTrainTalonRL);
        
        driveTrainTalonRR = new CANTalon(3);
        LiveWindow.addActuator("DriveTrain", "TalonRR", driveTrainTalonRR);
        ...
        sensorsNavX = new AHRS(Port.kMXP, (byte)50);
        LiveWindow.addSensor("Sensors", "NavX", sensorsNavX);
